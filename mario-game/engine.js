...
Engine.Drawable.prototype = { Draw: function () {} };
Engine.GameStateContext = function (a) {
    this.State = null;
...
Engine.GameState.prototype = { Enter: function () {}, Exit: function () {}, Update: function () {}, Draw: function () {}, CheckForChange: function () {} };
...
Engine.SpriteFont = function (a, b, c, d, e) {
    this.Image = b;
    this.Letters = e;
    this.LetterWidth = c;
    this.LetterHeight = d;
...
Engine.AnimatedSprite.prototype.Update = function (a) {
    if (!this.CurrentSequence.SingleFrame && this.Playing && ((this.LastElapsed -= a), !(this.LastElapsed > 0))) {
        ...
        this.FrameX > this.CurrentSequence.EndColumn * this.FrameWidth && this.FrameY == this.CurrentSequence.EndRow * this.FrameHeight
            ? (a = !0)
            : this.FrameX == 0 && this.FrameY > this.CurrentSequence.EndRow * this.FrameHeight && (a = !0);
