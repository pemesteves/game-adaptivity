var Mario={SpriteCuts:{CreateBlackFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(0))},CreateRedFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(8))},CreateGreenFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(16))},CreateBlueFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(24))},CreateYellowFont:function(){return new Engine.SpriteFont([],
Engine.Resources.Images.font,8,8,this.GetCharArray(32))},CreatePinkFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(40))},CreateCyanFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(48))},CreateWhiteFont:function(){return new Engine.SpriteFont([],Engine.Resources.Images.font,8,8,this.GetCharArray(56))},GetCharArray:function(a){for(var b=[],c=0,c=32;c<127;c++)b[c]={X:(c-32)*8,Y:a};return b},GetBackgroundSheet:function(){for(var a=
[],b=0,c=0,e=Engine.Resources.Images.background.width/32,d=Engine.Resources.Images.background.height/32,b=0;b<e;b++){a[b]=[];for(c=0;c<d;c++)a[b][c]={X:b*32,Y:c*32,Width:32,Height:32}}return a},GetLevelSheet:function(){for(var a=[],b=0,c=0,e=Engine.Resources.Images.map.width/16,d=Engine.Resources.Images.map.height/16,b=0;b<e;b++){a[b]=[];for(c=0;c<d;c++)a[b][c]={X:b*16,Y:c*16,Width:16,Height:16}}return a}},Tile:{BlockUpper:1,BlockAll:2,BlockLower:4,Special:8,Bumpable:16,Breakable:32,PickUpable:64,
...
0&&this.InvulnerableTime--;this.Visible=((this.InvulerableTime/2|0)&1)===0;this.WasOnGround=this.OnGround;var a=Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)?1.2:0.6;if(this.OnGround)this.Ducking=Engine.KeyboardInput.IsKeyDown(Engine.Keys.Down)&&this.Large?!0:!1;if(this.Xa>2)this.Facing=1;if(this.Xa<-2)this.Facing=-1;if(Engine.KeyboardInput.IsKeyDown(Engine.Keys.S)||this.JumpTime<0&&!this.OnGround&&!this.Sliding)if(this.JumpTime<0)this.Xa=this.XJumpSpeed,this.Ya=-this.JumpTime*this.YJumpSpeed,this.JumpTime++;
else if(this.OnGround&&this.MayJump)Engine.Resources.PlaySound("jump"),this.XJumpSpeed=0,this.YJumpSpeed=-1.9,this.JumpTime=7,this.Ya=this.JumpTime*this.YJumpSpeed,this.Sliding=this.OnGround=!1;else if(this.Sliding&&this.MayJump)Engine.Resources.PlaySound("jump"),this.XJumpSpeed=-this.Facing*6,this.YJumpSpeed=-2,this.JumpTime=-6,this.Xa=this.XJumpSpeed,this.Ya=-this.JumpTime*this.YJumpSpeed,this.Sliding=this.OnGround=!1,this.Facing=-this.Facing;else{if(this.JumpTime>0)this.Xa+=this.XJumpSpeed,this.Ya=
this.JumpTime*this.YJumpSpeed,this.JumpTime--}else this.JumpTime=0;if(Engine.KeyboardInput.IsKeyDown(Engine.Keys.Left)&&!this.Ducking){if(this.Facing===1)this.Sliding=!1;this.Xa-=a;if(this.JumpTime>=0)this.Facing=-1}if(Engine.KeyboardInput.IsKeyDown(Engine.Keys.Right)&&!this.Ducking){if(this.Facing===-1)this.Sliding=!1;this.Xa+=a;if(this.JumpTime>=0)this.Facing=1}if(!Engine.KeyboardInput.IsKeyDown(Engine.Keys.Left)&&!Engine.KeyboardInput.IsKeyDown(Engine.Keys.Right)||this.Ducking||this.Ya<0||this.OnGround)this.Sliding=
!1;Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)&&this.CanShoot&&this.Fire&&this.World.FireballsOnScreen<2&&(Engine.Resources.PlaySound("fireball"),this.World.AddSprite(new Mario.Fireball(this.World,this.X+this.Facing*6,this.Y-20,this.Facing)));this.CanShoot=!Engine.KeyboardInput.IsKeyDown(Engine.Keys.A);this.MayJump=(this.OnGround||this.Sliding)&&!Engine.KeyboardInput.IsKeyDown(Engine.Keys.S);this.XFlip=this.Facing===-1;this.RunTime+=Math.abs(this.Xa)+5;if(Math.abs(this.Xa)<0.5)this.Xa=this.RunTime=
...
this.GroundInertia:this.AirInertia;this.OnGround||(this.Ya+=3);if(this.Carried!==null&&(this.Carried.X*=this.X+this.Facing*8,this.Carried.Y*=this.Y-2,!Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)))this.Carried.Release(this),this.Carried=null}};
...
a,this.Y+=b,!0};
Mario.Character.prototype.IsBlocking=function(a,b,c,e){var d=!1,f=d=d=0,a=a/16|0,b=b/16|0;if(a===(this.X/16|0)&&b===(this.Y/16|0))return!1;d=this.World.Level.GetBlock(a,b);if((Mario.Tile.Behaviors[d&255]&Mario.Tile.PickUpable)>0){this.GetCoin();Engine.Resources.PlaySound("coin");this.World.Level.SetBlock(a,b,0);for(d=0;d<2;d++)for(f=0;f<2;f++)this.World.AddSprite(new Mario.Sparkle(this.World,a*16+d*8+(Math.random()*8|0),b*16+f*8+(Math.random()*8|0),0,0,0,2,5))}(d=this.World.Level.IsBlocking(a,b,c,
e))&&e<0&&this.World.Bump(a,b,this.Large);return d};
Mario.Character.prototype.Stomp=function(a){var b=0;if(!(this.DeathTime>0||this.World.Paused))if(b=a.Y-a.Height/2,this.SubMove(0,b-this.Y),a instanceof Mario.Enemy||a instanceof Mario.BulletBill)Engine.Resources.PlaySound("kick"),this.XJumpSpeed=0,this.YJumpSpeed=-1.9,this.JumpTime=8,this.Ya=this.JumpTime*this.YJumpSpeed,this.Sliding=this.OnGround=!1,this.InvulnerableTime=1;else if(a instanceof Mario.Shell)Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)&&a.Facing===0?(this.Carried=a,a.Carried=!0):(Engine.Resources.PlaySound("kick"),
this.XJumpSpeed=0,this.YJumpSpeed=-1.9,this.JumpTime=8,this.Ya=this.JumpTime*this.YJumpSpeed,this.Sliding=this.OnGround=!1,this.InvulnerableTime=1)};Mario.Character.prototype.GetHurt=function(){if(!(this.DeathTime>0||this.World.Paused)&&!(this.InvulnerableTime>0))this.Large?(this.World.Paused=!0,this.PowerUpTime=-18,Engine.Resources.PlaySound("powerdown"),this.Fire?this.SetLarge(!0,!1):this.SetLarge(!1,!1),this.InvulnerableTime=32):this.Die()};
Mario.Character.prototype.Win=function(){this.XDeathPos=this.X|0;this.YDeathPos=this.Y|0;this.World.Paused=!0;this.WinTime=1;Engine.Resources.PlaySound("exit")};Mario.Character.prototype.Die=function(){this.XDeathPos=this.X|0;this.YDeathPos=this.Y|0;this.World.Paused=!0;this.DeathTime=1;Engine.Resources.PlaySound("death");this.SetLarge(!1,!1)};
Mario.Character.prototype.GetFlower=function(){if(!(this.DeathTime>0&&this.World.Paused))this.Fire?(this.GetCoin(),Engine.Resources.PlaySound("coin")):(this.World.Paused=!0,this.PowerUpTime=18,Engine.Resources.PlaySound("powerup"),this.SetLarge(!0,!0))};
Mario.Character.prototype.GetMushroom=function(){if(!(this.DeathTime>0&&this.World.Paused))this.Large?(this.GetCoin(),Engine.Resources.PlaySound("coin")):(this.World.Paused=!0,this.PowerUpTime=18,Engine.Resources.PlaySound("powerup"),this.SetLarge(!0,!1))};Mario.Character.prototype.Kick=function(a){if(!(this.DeathTime>0&&this.World.Paused))Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)?(this.Carried=a,a.Carried=!0):(Engine.Resources.PlaySound("kick"),this.InvulnerableTime=1)};
Mario.Character.prototype.Get1Up=function(){Engine.Resources.PlaySound("1up");this.Lives++;if(this.Lives===99)this.Lives=99};Mario.Character.prototype.GetCoin=function(){this.Coins++;if(this.Coins===100)this.Coins=0,this.Get1Up()};Mario.LevelRenderer=function(a,b,c){this.Width=b;this.Height=c;this.Level=a;this.TilesY=(c/16|0)+1;this.AnimTime=this.Bounce=this.Tick=this.Delta=0;this.Background=Mario.SpriteCuts.GetLevelSheet()};Mario.LevelRenderer.prototype=new Engine.Drawable;
...
Mario.Sparkle=function(a,b,c,e,d){this.World=a;this.X=b;this.Y=c;this.Xa=e;this.Ya=d;this.XPic=Math.random()*2|0;this.YPic=0;this.Life=10+(Math.random()*5|0);this.XPicStart=this.XPic;this.YPicO=this.XPicO=4;this.PicHeight=this.PicWidth=8;this.Image=Engine.Resources.Images.particles};Mario.Sparkle.prototype=new Mario.NotchSprite;Mario.Sparkle.prototype.Move=function(){this.XPic=this.Life>10?7:this.XPicStart+(10-this.Life)*0.4|0;this.Life--<0&&this.World.RemoveSprite(this);this.X+=this.Xa;this.Y+=this.Ya};
Mario.CoinAnim=function(a,b,c){this.World=a;this.Life=10;this.Image=Engine.Resources.Images.map;this.PicWidth=this.PicHeight=16;this.X=b*16;this.Y=c*16-16;this.Xa=0;this.Ya=-6;this.XPic=0;this.YPic=2};Mario.CoinAnim.prototype=new Mario.NotchSprite;
...
Mario.Mushroom=function(a,b,c){this.RunTime=0;this.AirInertia=this.GroundInertia=0.89;this.OnGround=!1;this.Width=4;this.Height=24;this.World=a;this.X=b;this.Y=c;this.Image=Engine.Resources.Images.items;this.XPicO=8;this.YPicO=15;this.YPic=0;this.Height=12;this.Facing=1;this.PicWidth=this.PicHeight=16;this.Life=0};Mario.Mushroom.prototype=new Mario.NotchSprite;
...
Mario.Particle=function(a,b,c,e,d){this.World=a;this.X=b;this.Y=c;this.Xa=e;this.Ya=d;this.XPic=Math.random()*2|0;this.YPic=0;this.YPicO=this.XPicO=4;this.PicHeight=this.PicWidth=8;this.Life=10;this.Image=Engine.Resources.Images.particles};Mario.Particle.prototype=new Mario.NotchSprite;Mario.Particle.prototype.Move=function(){this.Life-this.Delta<0&&this.World.RemoveSprite(this);this.Life-=this.Delta;this.X+=this.Xa;this.Y+=this.Ya;this.Ya*=0.95;this.Ya+=3};
Mario.FireFlower=function(a,b,c){this.Width=4;this.Height=24;this.World=a;this.X=b;this.Y=c;this.Image=Engine.Resources.Images.items;this.XPicO=8;this.YPicO=15;this.XPic=1;this.YPic=0;this.Height=12;this.Facing=1;this.PicWidth=this.PicHeight=16;this.Life=0};Mario.FireFlower.prototype=new Mario.NotchSprite;
...
Mario.BulletBill.prototype.ShellCollideCheck=function(a){if(this.DeadTime!==0)return!1;var b=a.X-this.X,c=a.Y-this.Y;if(b>-16&&b<16&&c>-this.Height&&c<a.Height)return Engine.Resources.PlaySound("kick"),this.Dead=!0,this.Xa=0,this.Ya=1,this.DeadTime=100,!0;return!1};
Mario.FlowerEnemy=function(a,b,c){this.Image=Engine.Resources.Images.enemies;this.World=a;this.X=b;this.Y=c;this.Facing=1;this.Type=Mario.Enemy.Spiky;this.NoFireballDeath=this.Winged=!1;this.XPic=0;this.YPic=6;this.YPicO=24;this.Height=12;this.Width=2;this.YStart=c;this.Ya=-8;this.Y-=1;for(a=a=this.Tick=this.JumpTime=this.Layer=0;a<4;a++)this.Move()};Mario.FlowerEnemy.prototype=new Mario.Enemy;
...
this.JumpTime>40&&a>24?-8:0):this.JumpTime=0,this.Y+=this.Ya,this.Ya*=0.9,this.Ya+=0.1,this.XPic=((this.Tick/2|0)&1)*2+((this.Tick/6|0)&1)};Mario.Shell=function(a,b,c,e){this.World=a;this.X=b;this.Y=c;this.YPic=e;this.Image=Engine.Resources.Images.enemies;this.XPicO=8;this.YPicO=31;this.Width=4;this.Height=12;this.Facing=0;this.PicWidth=16;this.XPic=4;this.Ya=-5;this.Dead=!1;this.DeadTime=0;this.Carried=!1;this.AirInertia=this.GroundInertia=0.89;this.OnGround=!1;this.Anim=0};
...
-1;this.Xa=this.Facing*11;this.Facing!==0&&this.World.CheckShellCollide(this);this.XFlip=this.Facing===-1;this.XPic=(this.Anim/2|0)%4+3;if(!this.SubMove(this.Xa,0))Engine.Resources.PlaySound("bump"),this.Facing=-this.Facing;this.OnGround=!1;this.SubMove(0,this.Ya);this.Ya*=0.85;this.Xa*=this.OnGround?this.GroundInertia:this.AirInertia;this.OnGround||(this.Ya+=2)}};
...
Mario.Shell.prototype.Die=function(){this.Dead=!0;this.Carried=!1;this.Xa=-this.Facing*2;this.Ya=-5;this.DeadTime=100};Mario.Shell.prototype.ShellCollideCheck=function(a){if(this.DeadTime!==0)return!1;var b=a.X-this.X,c=a.Y-this.Y;if(b>-16&&b<16&&c>-this.Height&&c<a.Height){Engine.Resources.PlaySound("kick");if(Mario.MarioCharacter.Carried===a||Mario.MarioCharacter.Carried===this)Mario.MarioCharacter.Carried=null;this.Die();a.Die();return!0}return!1};
Mario.Shell.prototype.Release=function(){this.Carried=!1;this.Facing=Mario.MarioCharacter.Facing;this.X+=this.Facing*8};Mario.TitleState=function(){this.font=this.bounce=this.logoY=this.camera=this.drawManager=null};Mario.TitleState.prototype=new Engine.GameState;
Mario.TitleState.prototype.Enter=function(){this.drawManager=new Engine.DrawableManager;this.camera=new Engine.Camera;var a=new Mario.BackgroundGenerator(2048,15,!0,Mario.LevelType.Overground),b=new Mario.BackgroundRenderer(a.CreateLevel(),320,240,2);a.SetValues(2048,15,!1,Mario.LevelType.Overground);a=new Mario.BackgroundRenderer(a.CreateLevel(),320,240,1);this.title=new Engine.Sprite;this.title.Image=Engine.Resources.Images.title;this.title.X=0;this.title.Y=120;this.logo=new Engine.Sprite;this.logo.Image=
Engine.Resources.Images.logo;this.logo.X=0;this.logo.Y=0;this.font=Mario.SpriteCuts.CreateRedFont();this.font.Strings[0]={String:"Press S to Start",X:96,Y:120};this.logoY=20;this.drawManager.Add(b);this.drawManager.Add(a);this.bounce=0;Mario.GlobalMapState=new Mario.MapState;Mario.MarioCharacter=new Mario.Character;Mario.MarioCharacter.Image=Engine.Resources.Images.smallMario};Mario.TitleState.prototype.Exit=function(){this.drawManager.Clear();delete this.drawManager;delete this.camera;delete this.font};
Mario.TitleState.prototype.Update=function(a){this.bounce+=a*2;this.logoY=20+Math.sin(this.bounce)*10;this.camera.X+=a*25;this.drawManager.Update(a)};Mario.TitleState.prototype.Draw=function(a){this.drawManager.Draw(a,this.camera);a.drawImage(Engine.Resources.Images.title,0,120);a.drawImage(Engine.Resources.Images.logo,0,this.logoY);this.font.Draw(a,this.Camera)};Mario.TitleState.prototype.CheckForChange=function(a){Engine.KeyboardInput.IsKeyDown(Engine.Keys.S)&&a.ChangeState(Mario.GlobalMapState)};
Mario.LoadingState=function(){this.Images=[];this.ImagesLoaded=!1;this.ScreenColor=0;this.ColorDirection=1;this.SoundIndex=this.ImageIndex=0};Mario.LoadingState.prototype=new Engine.GameState;
...
{String:"Game over!",X:116,Y:160};this.drawManager.Add(this.font);this.drawManager.Add(this.gameOver)};Mario.LoseState.prototype.Exit=function(){this.drawManager.Clear();delete this.drawManager;delete this.camera;delete this.gameOver;delete this.font};Mario.LoseState.prototype.Update=function(a){this.drawManager.Update(a);if(Engine.KeyboardInput.IsKeyDown(Engine.Keys.S))this.wasKeyDown=!0};Mario.LoseState.prototype.Draw=function(a){this.drawManager.Draw(a,this.camera)};
Mario.LoseState.prototype.CheckForChange=function(a){this.wasKeyDown&&!Engine.KeyboardInput.IsKeyDown(Engine.Keys.S)&&a.ChangeState(new Mario.TitleState)};Mario.WinState=function(){this.waitTime=2;this.kissing=this.font=this.camera=this.drawManager=null;this.wasKeyDown=!1};Mario.WinState.prototype=new Engine.GameState;
Mario.WinState.prototype.Enter=function(){this.drawManager=new Engine.DrawableManager;this.camera=new Engine.Camera;this.font=Mario.SpriteCuts.CreateBlackFont();this.font.Strings[0]={String:"Thank you for saving me, Mario!",X:36,Y:160};this.kissing=new Engine.AnimatedSprite;this.kissing.Image=Engine.Resources.Images.endScene;this.kissing.X=112;this.kissing.Y=52;this.kissing.SetColumnCount(2);this.kissing.SetRowCount(1);this.kissing.AddNewSequence("loop",0,0,0,1);this.kissing.PlaySequence("loop",!0);
this.kissing.FramesPerSecond=0.5;this.waitTime=2;this.drawManager.Add(this.font);this.drawManager.Add(this.kissing)};Mario.WinState.prototype.Exit=function(){this.drawManager.Clear();delete this.drawManager;delete this.camera};Mario.WinState.prototype.Update=function(a){this.drawManager.Update(a);if(this.waitTime>0)this.waitTime-=a;else if(Engine.KeyboardInput.IsKeyDown(Engine.Keys.S))this.wasKeyDown=!0};Mario.WinState.prototype.Draw=function(a){this.drawManager.Draw(a,this.camera)};
Mario.WinState.prototype.CheckForChange=function(a){this.waitTime<=0&&this.wasKeyDown&&!Engine.KeyboardInput.IsKeyDown(Engine.Keys.S)&&a.ChangeState(new Mario.TitleState)};Mario.MapTile={Grass:0,Water:1,Level:2,Road:3,Decoration:4};
Mario.MapState=function(){this.camera=new Engine.Camera;this.Level=[];this.Data=[];this.YFarthestCap=this.XFarthestCap=this.Farthest=this.LevelId=this.MoveTime=this.YMarioA=this.XMarioA=this.YMario=this.XMario=0;this.MapImage=document.createElement("canvas");this.MapImage.width=320;this.MapImage.height=240;this.MapContext=this.MapImage.getContext("2d");this.EnterLevel=this.CanEnterLevel=!1;this.LevelType=this.LevelDifficulty=0;this.WorldNumber=-1;this.NextWorld()};Mario.MapState.prototype=new Engine.GameState;
Mario.MapState.prototype.Enter=function(){this.WaterSprite=new Engine.AnimatedSprite;this.WaterSprite.Image=Engine.Resources.Images.worldMap;this.WaterSprite.SetColumnCount(16);this.WaterSprite.SetRowCount(16);this.WaterSprite.AddNewSequence("loop",14,0,14,3);this.WaterSprite.FramesPerSecond=1/3;this.WaterSprite.PlaySequence("loop",!0);this.WaterSprite.X=0;this.WaterSprite.Y=0;this.DecoSprite=new Engine.AnimatedSprite;this.DecoSprite.Image=Engine.Resources.Images.worldMap;this.DecoSprite.SetColumnCount(16);
this.DecoSprite.SetRowCount(16);this.DecoSprite.AddNewSequence("world0",10,0,10,3);this.DecoSprite.AddNewSequence("world1",11,0,11,3);this.DecoSprite.AddNewSequence("world2",12,0,12,3);this.DecoSprite.AddNewSequence("world3",13,0,13,3);this.DecoSprite.FramesPerSecond=1/3;this.DecoSprite.PlaySequence("world0",!0);this.DecoSprite.X=0;this.DecoSprite.Y=0;this.HelpSprite=new Engine.AnimatedSprite;this.HelpSprite.Image=Engine.Resources.Images.worldMap;this.HelpSprite.SetColumnCount(16);this.HelpSprite.SetRowCount(16);
this.HelpSprite.AddNewSequence("help",7,3,7,5);this.HelpSprite.FramesPerSecond=0.5;this.HelpSprite.PlaySequence("help",!0);this.HelpSprite.X=0;this.HelpSprite.Y=0;this.SmallMario=new Engine.AnimatedSprite;this.SmallMario.Image=Engine.Resources.Images.worldMap;this.SmallMario.SetColumnCount(16);this.SmallMario.SetRowCount(16);this.SmallMario.AddNewSequence("small",1,0,1,1);this.SmallMario.FramesPerSecond=1/3;this.SmallMario.PlaySequence("small",!0);this.SmallMario.X=0;this.SmallMario.Y=0;this.LargeMario=
new Engine.AnimatedSprite;this.LargeMario.Image=Engine.Resources.Images.worldMap;this.LargeMario.SetColumnCount(16);this.LargeMario.SetRowCount(8);this.LargeMario.AddNewSequence("large",0,2,0,3);this.LargeMario.AddNewSequence("fire",0,4,0,5);this.LargeMario.FramesPerSecond=1/3;this.LargeMario.PlaySequence("large",!0);this.LargeMario.X=0;this.LargeMario.Y=0;this.FontShadow=Mario.SpriteCuts.CreateBlackFont();this.Font=Mario.SpriteCuts.CreateWhiteFont();this.DecoSprite.PlaySequence("world"+this.WorldNumber%
...
!Engine.KeyboardInput.IsKeyDown(Engine.Keys.S);Engine.KeyboardInput.IsKeyDown(Engine.Keys.Left)&&this.TryWalking(-1,0);Engine.KeyboardInput.IsKeyDown(Engine.Keys.Right)&&this.TryWalking(1,0);Engine.KeyboardInput.IsKeyDown(Engine.Keys.Up)&&this.TryWalking(0,-1);Engine.KeyboardInput.IsKeyDown(Engine.Keys.Down)&&this.TryWalking(0,1)}this.WaterSprite.Update(a);this.DecoSprite.Update(a);this.HelpSprite.Update(a);Mario.MarioCharacter.Large?(this.LargeMario.X=this.XMario+this.XMarioA*a|0,this.LargeMario.Y=
...
Mario.LevelState.prototype.Bump=function(a,b,c){var e=this.Level.GetBlock(a,b),d=0,f=0;(Mario.Tile.Behaviors[e&255]&Mario.Tile.Bumpable)>0&&(this.BumpInto(a,b-1),this.Level.SetBlock(a,b,4),this.Level.SetBlockData(a,b,4),(Mario.Tile.Behaviors[e&255]&Mario.Tile.Special)>0?(Engine.Resources.PlaySound("sprout"),Mario.MarioCharacter.Large?this.AddSprite(new Mario.FireFlower(this,a*16+8,b*16+8)):this.AddSprite(new Mario.Mushroom(this,a*16+8,b*16+8))):(Mario.MarioCharacter.GetCoin(),Engine.Resources.PlaySound("coin"),
this.AddSprite(new Mario.CoinAnim(this,a,b))));if((Mario.Tile.Behaviors[e&255]&Mario.Tile.Breakable)>0&&(this.BumpInto(a,b-1),c)){Engine.Resources.PlaySound("breakblock");this.Level.SetBlock(a,b,0);for(d=0;d<2;d++)for(f=0;f<2;f++)this.AddSprite(new Mario.Particle(this,a*16+d*8+4,b*16+f*8+4,(d*2-1)*4,(f*2-1)*4-8))}};
Mario.LevelState.prototype.BumpInto=function(a,b){var c=this.Level.GetBlock(a,b),e=0;(Mario.Tile.Behaviors[c&255]&Mario.Tile.PickUpable)>0&&(Mario.MarioCharacter.GetCoin(),Engine.Resources.PlaySound("coin"),this.Level.SetBlock(a,b,0),this.AddSprite(new Mario.CoinAnim(a,b+1)));for(e=0;e<this.Sprites.Objects.length;e++)this.Sprites.Objects[e].BumpCheck(a,b)};Mario.LevelState.prototype.CheckForChange=function(a){this.GotoLoseState?a.ChangeState(new Mario.LoseState):this.GotoMapState&&a.ChangeState(Mario.GlobalMapState)};